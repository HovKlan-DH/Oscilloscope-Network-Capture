...
The keyboard actions have been done to support having an external numpad nearby your scope, so you can easily control the scope, without needing to fiddle with scope knots:
