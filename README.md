...
The keyboard actions were implemented to support using an external numpad placed near your measurement bench, allowing you to control the scope easily without having to fiddle with the knobs.
